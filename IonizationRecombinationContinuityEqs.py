...
h1 = 2.0 * 10**8 #cm
h2 = 1.0 * 10**8 #cm
n_n_0 =  1.0 * 10**14 #cm^-3
n_i_0 = n_n_0 * 0.0001 #cm^-3
T_n = 11600.0 #K
T_i = 13.6 * 11600.0 #K
m = 1.6 * 10**(-24) 
...
def forward_euler(n_t, T, n_z, u_0, pre_calc, tem_i_0, tem_n_0, coef_0):
    ...
    print('dt = %f\n' %dt)
    return u, pre_e, tem_i, tem_n, coef, t 

########## plotting section ###################################################################

[u, pre_e, tem_i, tem_n, coef, t] = forward_euler(n_t, T, n_z, u_0, pre_calc, tem_i_0, tem_n_0, coef_0)
u = np.array(u)
